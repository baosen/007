...
.section .text, "ax"
  ...
  lui   $t0, 0xa470
  addiu $t0, $t0, 0
  lui   $t2, %hi(0xA3F80004) # $t2, 0xa3f8
  lui   $t3, 0xa3f0
  lui   $t4, 0xa430
  addiu $t4, $t4, 0
  ori   $t1, $zero, 64
...
.L0000009C:
  ...
  sw    $t1, %lo(0xA3F80008)($t2)
  sw    $zero, %lo(0xA3F80014)($t2)
  lui   $t1, 0x8000
  sw    $t1, %lo(0xA3F80004)($t2)
  move  $t5, $zero
  move  $t6, $zero
  lui   $t7, %hi(0xA3F00018) # $t7, 0xa3f0
  move  $t8, $zero
  lui   $t9, 0xa3f0
  lui   $s6, 0xa000
  move  $s7, $zero
  ...
  addiu $sp, $sp, -0x48
  move  $fp, $sp
  lui   $s0, %hi(0xA4300004) # $s0, 0xa430
...
.L0000021C:
  lui   $t0, 0xc400
  sw    $t0, %lo(0xA3F8000C)($t2)
  lui   $t0, 0x8000
  sw    $t0, %lo(0xA3F80004)($t2)
  move  $sp, $fp
  move  $v1, $zero
.L00000234:
  lw    $t1, 4($sp)
...
.L0000031C:
  ...
  bnez  $t0, .L00000234
   nop   
  lui   $t2, %hi(0xA4700010) # $t2, 0xa470
  sll   $s2, $s2, 0x13
...
.L00000418:
  ...
  and   $t2, $t2, $t3
  lui   $t0, %hi(0xA40004C0) # $t0, 0xa400
  addiu $t1, -1 # addiu $t1, $t1, -1
  lui   $t3, %hi(0xA4000774) # $t3, 0xa400
  addiu $t0, %lo(0xA40004C0) # addiu $t0, $t0, 0x4c0
  addiu $t3, %lo(0xA4000774) # addiu $t3, $t3, 0x774
  and   $t0, $t0, $t1
  and   $t3, $t3, $t1
  lui   $t1, 0xa000
  or    $t0, $t0, $t2
...
.L00000458:
  ...
  jr    $t4
   nop   
  lui   $t3, %hi(0xB0000008) # $t3, 0xb000
  lw    $t1, %lo(0xB0000008)($t3)
  lui   $t2, (0x1FFFFFFF >> 16) # lui $t2, 0x1fff
  ori   $t2, (0x1FFFFFFF & 0xFFFF) # ori $t2, $t2, 0xffff
  lui   $at, 0xa460
  and   $t1, $t1, $t2
  sw    $t1, ($at)
  lui   $t0, %hi(0xA4600010) # $t0, 0xa460
.L000004A0:
  lw    $t0, %lo(0xA4600010)($t0)
  andi  $t0, $t0, 2
  bnezl $t0, .L000004A0
   lui   $t0, 0xa460
  li    $t0, 4096
...
.L000004D4:
  ...
  nop   
  nop   
  lui   $t3, %hi(0xA4600010) # $t3, 0xa460
...
.L00000600:
  ...
  xor   $t8, $s0, $a2
  xor   $s0, $t8, $t4
  lui   $t3, %hi(0xB0000014) # $t3, 0xb000
  ...
  bal   func_00000690
   nop   
glabel func_00000688
.L00000648:
  bal   func_00000688
   nop   
glabel func_00000690
  lui   $t1, 0xa408
  lw    $t1, ($t1)
  lw    $s0, 0x14($sp)
  lw    $ra, 0x1c($sp)
  beqz  $t1, .L0000067C
   addiu $sp, $sp, 0x20
  li    $t2, 65
  lui   $at, %hi(0xA4040010) # $at, 0xa404
...
.L0000067C:
  ...
  lui   $at, %hi(0xA430000C) # $at, 0xa430
  li    $t0, 1365
  sw    $t0, %lo(0xA430000C)($at)
  lui   $at, %hi(0xA4800018) # $at, 0xa480
  sw    $zero, %lo(0xA4800018)($at)
  lui   $at, %hi(0xA450000C) # $at, 0xa450
  sw    $zero, %lo(0xA450000C)($at)
  lui   $at, 0xa430
  li    $t1, 2048
  sw    $t1, ($at)
  li    $t1, 2
  lui   $at, %hi(0xA4600010) # $at, 0xa460
  lui   $t0, %hi(0xA0000008) # $t0, 0xa000
  ori   $t0, (0xA0000300 & 0xFFFF) # ori $t0, $t0, 0x300
  sw    $t1, %lo(0xA4600010)($at)
  sw    $s7, %lo(0xA0000014)($t0)
  sw    $s5, %lo(0xA000000C)($t0)
  sw    $s3, %lo(0xA0000004)($t0)
  beqz  $s3, .L000006E8
   sw    $s4, ($t0)
  lui   $t1, 0xa600
  b     .L000006F0
...
.L00000700:
  ...
  bne   $t0, $t1, .L00000700
   sw    $zero, -4($t0)
  lui   $t0, %hi(0xA4001000) # $t0, 0xa400
  addiu $t0, %lo(0xA4001000) # addiu $t0, $t0, 0x1000
  addi  $t1, $t0, 0x1000
.L00000718:
  addiu $t0, $t0, 4
  bne   $t0, $t1, .L00000718
