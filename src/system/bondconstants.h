...
#define CHRFLAG_CLONE                                                          \
  0x00000002 // clone on heard gunfire (used by
             // GLIST_DETECT_BOND_SPAWN_CLONE_ON_HEARD_GUNFIRE)
#define CHRFLAG_NEAR_MISS                                                      \
  0x00000004 // chr was just nearly shot (sometimes set on direct hit)
...
#define CHRFLAG_LOCK_Y_POS                                                     \
  0x00001000 // lock y position (no gravity, used for dam/cradle jump)
#define CHRFLAG_NO_SHADOW 0x00002000 // no shadow
#define CHRFLAG_IGNORE_ANIM_TRANSLATION                                        \
  0x00004000                        // ignore animation translation
...
#define CHRFLAG_INCREASE_SPRINT_SPEED                                          \
  0x00080000 // increase sprinting speed (used by trevelyan)
#define CHRFLAG_COUNT_DEATH_AS_CIVILIAN                                        \
  0x00100000                        // count death as civilian killed
#define CHRFLAG_WAS_HIT 0x00200000  // chr has been hit (even if invincible)
#define CHRFLAG_00400000 0x00400000 // unknown
#define CHRFLAG_CULL_USING_HITBOX                                              \
  0x00800000 // cull chr using hitbox instead of tile/clipping (useful with lock
             // y pos flag)
