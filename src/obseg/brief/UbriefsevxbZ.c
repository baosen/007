...
struct BriefStruct UbriefsevxbZ = {
    ...
    },
    {
        ...
        {TEXT(LSEVXB, 4),
         DIFFICULTY_00}, /* Disrupt all surveillance equipment */
        {TEXT(LSEVXB, 5),
         DIFFICULTY_AGENT}, /* Break communications link to bunker */
        {TEXT(LSEVXB, 6),
         DIFFICULTY_SECRET}, /* Disable Spetznaz support aircraft */
