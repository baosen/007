...
typedef struct {
  ...
  int zpos3;
  int room_pointer;
  int current_model_xpos;
  int current_model_ypos;
  int current_model_zpos;
  int previous_model_xpos;
  int previous_model_ypos;
  int previous_model_zpos;
  int current_room_xpos;
  int current_room_ypos;
  int current_room_zpos;
  int field_5C;
  int field_60;
  int field_64;
  int field_68;
  ...
  int field_1C0;
  int field_1C4;
  int watch_animation_state;
  int paused_flag;
  int open_close_solo_watch_menu;
  int field_1D4;
  int field_1D8;
  int pause_watch_position;
  int field_1E0;
  int field_1E4;
  int field_1E8;
  int field_1EC;
  ...
  int field_1FC;
  int pausing_flag;
  float pause_starting_angle;
  int field_208;
  int pause_target_angle;
  float field_210;
  float field_214;
  int field_218;
  int field_21C;
  int step_in_view_watch_animation;
  int pause_animation_counter;
  int field_228;
  int field_22C;
  ...
  int tint_blue;
  float tint_alpha;
  int screen_fade_timer;
  float screen_fade_max_time;
  int field_3E8;
  int field_3EC;
  int field_3F0;
  int field_3F4;
  ...
  int field_4D0;
  int field_4D4;
  int current_tile_ptr_for_portals;
  int field_4DC;
  int field_4E0;
  int field_4E4;
  int field_4E8;
  ...
  int left_invisible;
  int handitem[2];
  int ptr_right_weapon_buffer;
  int ptr_left_weapon_buffer;
  ...
  int field_FD4;
  int field_FD8;
  unsigned char field_FDC;
  unsigned char field_FDD;
  unsigned char field_FDE;
  unsigned char field_FDF;
  int field_FE0;
  int field_FE4;
  float field_FE8;
  float field_FEC;
  float crosshair_x_pos;
  float crosshair_y_pos;
  float field_FF8;
  float field_FFC;
  float field_1000;
  float gun_azimuth_angle;
  float gun_azimuth_turning;
  float field_100C;
  float field_1010;
  float holds_neg_pi;
  float field_1018;
  ...
  int field_112C;
  int ammoheldarr;
  int ammo_total_pistol;
  int ammo_total_pistol_beta;
  int ammo_total_rifle;
  int ammo_total_shotgun;
  int ammo_total_grenade;
  int ammo_total_rocket_launcher;
  int ammo_total_remote_mine;
  int ammo_total_prox_mine;
  int ammo_total_timed_mine;
  int ammo_total_throwing_knife;
  int ammo_total_grenade_launcher;
  int ammo_total_magnum;
  int ammo_total_golden_gun;
  int ammo_total_dart;
  int ammo_total_explosive_pen;
  int ammo_total_explosive_case;
  int ammo_total_flare;
  int ammo_total_piton;
  int ammo_total_dynamite;
  int ammo_total_bug;
  int ammo_total_microcamera;
  int ammo_total_goldeneye_key;
  int ammo_total_plastique;
  int ammo_total_watch_laser;
  int ammo_total_watch_magnet;
  int ammo_total_unknown1;
  int ammo_total_unknown2;
  int ammo_total_tank;
  int ammo_total_mp_token;
  int bloodcnt;
  int field_11AC;
  int field_11B0;
  int field_11B4;
  ...
  int field_12AC;
  int field_12B0;
  unsigned char something_with_cheat_text;
  unsigned char can_display_cheat_text;
  unsigned char bondinvincible;
  unsigned char field_12B7;
  ...
  unsigned int has_set_control_type_data;
  int field_2A6C;
  int field_2A70;
  int field_2A74;
  int field_2A78;
