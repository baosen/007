...
glabel sub_GAME_7F0790F0
  ...
  lui   $s4, %hi(ptr_BONDdata_p1)
  mtc1  $at, $f20
  addiu $s4, %lo(ptr_BONDdata_p1) # addiu $s4, $s4, -0x6120
...
.L7F089B10:
  ...
  lw    $t0, 0x38($sp)
  li    $at, 0x43B40000 # 360.000000
  lui   $t2, %hi(ptr_BONDdata_p1)
  sll   $t1, $t0, 2
  mtc1  $at, $f4
  addu  $t2, $t2, $t1
  div.s $f18, $f6, $f16
  lw    $t2, %lo(ptr_BONDdata_p1)($t2)
  mtc1  $zero, $f12
  lw    $t3, 0x4c($sp)
  lwc1  $f10, 0x148($t2)
  li    $at, 0x42B40000 # 90.000000
...
.Ljp7F08A200:
  ...
  lw    $t8, 0x38($sp)
  li    $at, 0x43B40000 # 360.000000
  lui   $t0, %hi(ptr_BONDdata_p1)
  sll   $t9, $t8, 2
  mtc1  $at, $f16
  addu  $t0, $t0, $t9
  div.s $f6, $f8, $f10
  lw    $t0, %lo(ptr_BONDdata_p1)($t0)
  mtc1  $zero, $f12
  lw    $t1, 0x4c($sp)
  lwc1  $f4, 0x148($t0)
  li    $at, 0x42B40000 # 90.000000
...
glabel sub_GAME_7F08A0B0
  ...
  addiu $a0, %lo(ptr_BONDdata_p1) # addiu $a0, $a0, -0x6120
  sll   $t6, $v0, 2
  addu  $t7, $a0, $t6
  lw    $t8, ($t7)
  lw    $t9, 0xac($t8)
...
.L7F08B148:
  ...
  beqz  $t1, .L7F08B288
   sll   $t3, $t2, 2
  addiu $t4, %lo(ptr_BONDdata_p1) # addiu $t4, $t4, -0x6120
  addu  $s1, $t3, $t4
  lw    $t5, ($s1)
  lw    $t6, 0xd4($t5)
