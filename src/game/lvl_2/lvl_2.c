...
glabel copy_current_ingame_registers_before_ramrom_playback
  ...
  sw    $t7, 4($a0)
  sw    $t6, ($a0)
  lui   $t8, %hi(game_random_seed) 
  lui   $t9, %hi(game_random_seed + 0x4) 
  lw    $t9, %lo(game_random_seed + 0x4)($t9)
  lw    $t8, %lo(game_random_seed)($t8)
  lui   $t0, %hi(gamemode) 
  sw    $t9, 0xc($a0)
  sw    $t8, 8($a0)
...
glabel copy_recorded_ramrom_registers_to_proper_place_ingame
  ...
  sw    $t8, %lo(game_random_seed)($at)
  lui   $at, %hi(game_random_seed + 0x4)
  sw    $t9, %lo(game_random_seed + 0x4)($at)
  lw    $t0, 0x84($a0)
  lui   $at, %hi(gamemode)
  move  $s0, $a0
